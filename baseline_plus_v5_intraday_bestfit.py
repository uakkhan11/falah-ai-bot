...
def create_ml_features(m15_df, hourly_df):
    ...
    # Forward fill hourly features for 15m rows
            ...
            for pt in profit_target_params:
                ...
                for symbol in symbols:
                    try:
                        ...
                        # Create ML features and train model per symbol

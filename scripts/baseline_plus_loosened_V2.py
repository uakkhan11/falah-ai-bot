...
PROFIT_TARGET   = 0.10
ATR_SL_MULT     = 2.8         # v2: reduced SL sensitivity
ATR_PERIOD      = 14
TRAIL_TRIGGER   = 0.07
TRAIL_DISTANCE  = 0.03
...
# Default thresholds for pullbacks; breakouts have their own loosened rules
ADX_THRESHOLD_DEFAULT = 15
ADX_THRESHOLD_BREAKOUT = 12    # v2: loosened
VOLUME_MULT_DEFAULT = 1.2
VOLUME_MULT_BREAKOUT = 1.1     # v2: loosened
...
def add_indicators(df):
    ...
    cols = ['close','donchian_high','ema200','adx','vol_sma20','bb_upper','bb_lower',
            'wpr','atr','chandelier_exit','supertrend','supertrend_dir']
...
def backtest(df, symbol):
    ...
    regime_fail_count = {}  # track consecutive bars failing regime for pos
...
if __name__ == "__main__":
    ...
    log_df.to_csv("baseline_plus_loosened_v2_log.csv", index=False)
